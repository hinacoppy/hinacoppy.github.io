...
class BgBoard {
  ...
  showPosition(xg) {
    ...
    for (let player = 1; player <= 2; player++) {
      for (let i = 0; i < 15; i++) {
        ...
        const which2 = (pt > 12 && this.topbottomFlag) || (pt <= 12 && !this.topbottomFlag);
        bf = false;
  ...
  calcAftPosition(player, topt) {
    ...
    const which2 = (toabs > 12 && this.topbottomFlag) || (toabs <= 12 && !this.topbottomFlag);
